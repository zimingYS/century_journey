...
pub fn completions(line: &str) -> CommandCompletions {
    ...
    if completed.is_empty() {
        ...
        complete_arguments(completed, prefix)
    }
}
...
fn complete_arguments(completed: &[&str], prefix: &str) -> CommandCompletions {
    ...
    let candidates = (spec.suggest)(&completed[1..], prefix);
