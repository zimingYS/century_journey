use bevy::prelude::*;
use crate::player::view_model::{ViewModelRoot, HeldItemEntity, ViewModelAnimator, ViewModelRenderState};
...
use crate::rendering::held_render::{HeldRenderDefinition, block_renderer::HeldBlockRenderer, flat_item_renderer::HeldFlatItemRenderer, hand_renderer::HandRenderer, HeldItemConfig};
use crate::rendering::mesh_cache::HeldMeshCache;
...
fn resolve_held_config(
    ...
    use crate::rendering::held_render::HeldItemConfig;
...
fn spawn_model_item(
    ...
    // 通过模型渲染器加载GLTF场景
    let scene = crate::rendering::held_render::model_renderer::HeldModelRenderer::load_model(asset_server, path);
    let root = commands.spawn((
