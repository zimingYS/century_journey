use bevy::prelude::*;
use crate::ui::components::{Crosshair, HudRoot};
...
pub fn setup_crosshair(
    ...
    commands.entity(hud_entity).with_children(|parent| {
        parent.spawn((
            ...
            parent.spawn((
                Node { width: Val::Px(20.0), height: Val::Px(2.0), ..default() },
                BackgroundColor(Color::srgba(1.0, 1.0, 1.0, 0.8)),
            ));
            parent.spawn((
                Node { position_type: PositionType::Absolute, width: Val::Px(2.0), height: Val::Px(20.0), ..default() },
                BackgroundColor(Color::srgba(1.0, 1.0, 1.0, 0.8)),
            ));
        });
    });
